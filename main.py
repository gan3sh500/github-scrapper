...
if __name__ == '__main__':
    ...
    dataset = Dataset(r"D:\Personal\data\github-scrapper\issues\2021_04_06_20_13_23\PyTorchLightning_lightning-bolts.json")
    commit_ids = list(str(x) for x in set(match_issue_to_commit(dataset.get_issues, dataset.get_commits).id))
    engine = InferenceEngine(repo_dir=Path("D:\Personal\data\github-scrapper\repos\lightning-bolts"),
    ...
    for issue in dataset.get_issues_iter():
        ...
        # dataset.get_relevant_files_for_issue()